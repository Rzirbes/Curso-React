...
export default function () {
    ...
    return (
        <Pagina titulo="Referência Vs State" subtitulo="Entendendo useRef">
            ...
            <Flex gap={5}>
                <Botao onClick={() => incrementaReferencia()}tamanho="2xl" cor="bg-pink-500" texto="R+"></Botao>
                <Botao onClick={() => setEstado(estado + 1)} tamanho="2xl" cor="bg-green-500" texto="S+"></Botao>
            </Flex>
        </Pagina>
    )
}